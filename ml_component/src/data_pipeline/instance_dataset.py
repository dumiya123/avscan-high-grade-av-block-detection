...
from src.data_pipeline.augmentations import get_research_augmentations
...
class AtrionInstanceDataset(Dataset):
    ...
    def _augment(self, sig, centers, spans):
        """Standard Data Augmentation without MixUp to preserve clear labels."""
        # 1. Apply baseline augmentations from Joung et al. (2024)
    ...
    def __getitem__(self, idx):
        ...
        width_map = np.zeros((1, self.seq_len), dtype=np.float32)
